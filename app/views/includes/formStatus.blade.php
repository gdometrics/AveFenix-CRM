  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Agregar Estatus</h4>
      </div>
      <div class="modal-body">

        @include('includes.alerts-box') 
        
          {{ Form::open(array('url'=>'status/create', 'class'=>'form-signup')) }} 
            <div class="register-form">
                ...
                <div class="form-group">  
                  <table class="table-ex">
                    <tr>
                      ...
                      <td>&nbsp;</td>
                      <td>{{ Form::select('id_contact', $contacts, null, array('class'=>'form-control', 'placeholder'=>'Contacto del cliente')) }}</td>
                    </tr>
                  </table> 
                </div>  
                <div class="form-group">
               ...
               {{ Form::hidden('id_user', Auth::user()->id, array('class'=>'form-control', 'placeholder'=>'Ejecutiva')) }}    
                ...
                <div class="form-group"> 
                  {{ Form::hidden('id_client', $client["id"], array('class'=>'form-control', 'placeholder'=>'Cliente')) }}  
                </div>         
